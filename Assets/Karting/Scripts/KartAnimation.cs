...
public class KartAnimation : MonoBehaviour
{
    ...
    [Tooltip("A reference to a script that provides information about the kart's movement, usually the KartMovement script.")]
    ...
    void FixedUpdate()
    {
        m_SmoothedSteeringInput = Mathf.MoveTowards(m_SmoothedSteeringInput, m_KartMovement.Steering, steeringAnimationDamping * Time.deltaTime);
